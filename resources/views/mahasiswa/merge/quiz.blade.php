...
<head>
    ...
    <title>Quiz Merge Sort</title>
    
    <!-- Ganti CDN Tailwind ke Bootstrap 5 -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet">
    <!-- FontAwesome (Opsional, menyesuaikan icon Anda) -->
    ...
    /* Class spesifik yang dipakai oleh JavaScript Drag & Drop Anda */
        ...
        <div class="col-12 col-lg-9">
            ...
            <div id="intro-area" class="card border-primary-subtle shadow-sm rounded-4 border p-4 p-md-5 intro-card">
                ...
                <ol class="fs-5 text-secondary ps-4 mb-5" style="line-height: 1.8;">
                    <li class="mb-2">Latihan ini terdiri dari <b>10 soal</b> tentang Algoritma Merge Sort.</li>
                ...
                <div class="d-flex gap-3">
                    <a href="{{ route('mahasiswa.aktivitas.show',['merge','materi']) }}" class="btn btn-light border fw-bold px-4 py-2 text-primary">
                        Kembali ke Materi
                    </a>
            ...
            <div id="quiz-area" class="card border-primary-subtle shadow-sm rounded-4 border p-4 p-md-5 d-none">
                ...
                <div id="soal-container">
                    ...
                    <div class="soal {{ $index != 0 ? 'd-none' : '' }}" data-nomor="{{ $s->nomor }}">
                        ...
                        <p class="fw-bold text-primary mb-3 fs-5">Soal {{ $s->nomor }}</p>
...
<script>
    ...
    function drop(ev, nomorSoal) {
        ...
        // SYARAT PENTING: Harus ada class border-dashed (sudah disesuaikan di CSS)
            ...
            if (result.isConfirmed) {
                ...
                .then(data => {
                    ...
                    Swal.fire({
                        ...
                        window.location.href = "{{ route('mahasiswa.aktivitas.show',['merge','materi']) }}";
                    });
                })
                .catch(error => {
