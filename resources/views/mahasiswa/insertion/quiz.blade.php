...
<head>
    ...
    <title>Quiz Insertion Sort</title>
        ...
        <div class="col-12 col-lg-9">
            ...
            <div id="intro-area" class="card border-primary-subtle shadow-sm rounded-4 border p-4 p-md-5 intro-card">
                ...
                <ol class="fs-5 text-secondary ps-4 mb-5" style="line-height: 1.8;">
                    <li class="mb-2">Latihan ini terdiri dari <b>10 soal</b> tentang Algoritma Insertion Sort.</li>
                ...
                <div class="d-flex gap-3">
                    <a href="{{ route('mahasiswa.aktivitas.show',['insertion','materi']) }}" class="btn btn-light border fw-bold px-4 py-2 text-primary">
                        Kembali ke Materi
                    </a>
