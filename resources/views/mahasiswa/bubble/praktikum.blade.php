        ...
        <div class="card-body materi-text">
            ...
            @else
                <div class="alert alert-info mb-4">
                    <strong>Instruksi:</strong> Tuliskan penjelasan mengenai alur kerja algoritma Bubble Sort yang telah Anda buat pada kode di atas. Jika sudah yakin, klik tombol <strong>Submit Praktikum</strong> untuk mengumpulkan jawaban Anda.
                </div>
            @endif
            <div class="mb-4">
                ...
                <textarea 
                    ...
                    class="form-control"
                    rows="6"
                    placeholder="Jelaskan secara singkat namun jelas bagaimana algoritma Bubble Sort Anda bekerja..."
