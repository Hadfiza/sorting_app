    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 items-start">
        ...
        <div id="intro-area" class="md:col-span-3 bg-white p-8 rounded-2xl shadow-sm border border-blue-100 intro-card">
            ...
            <div class="flex gap-4 mt-10">
                <a href="/mahasiswa/pendahuluan/sorting"
...
<script>
    ...
    function markAnswered(nomor) {
        ...
        // kalau sedang ragu, jangan override warna
    ...
    function hitungNilai() {
            ...
            Swal.fire({
                ...
                Swal.fire({
                    ...
                    window.location.href = "/mahasiswa/pendahuluan/sorting"; 
                });
            }
        });
    }
    ...
    // ================= TIMER =================
    let totalWaktu = 10 * 60; // 10 menit (dalam detik)
    let intervalTimer;
