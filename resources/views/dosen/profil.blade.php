...
<div class="container py-5 mt-4">
    ...
    <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
        ...
        <div class="card-header border-0 text-white p-4 p-md-5 position-relative" style="background: linear-gradient(135deg, #1e3a8a, #3b82f6);">
            ...
            <div class="d-flex flex-column flex-md-row align-items-center align-items-md-start position-relative z-1">
                ...
                <div class="text-center text-md-start mt-md-2">
                    ...
                    <span class="badge bg-light text-primary px-3 py-2 rounded-pill shadow-sm">
                        <i class="fa-solid fa-chalkboard-user me-1"></i> Dosen Pengampu
                    </span>
                </div>
        ...
        <div class="card-body p-4 p-md-5">
            <h5 class="fw-bold text-dark mb-4 border-bottom pb-3"><i class="fa-solid fa-id-card text-primary me-2"></i>Detail Informasi Dosen</h5>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-12">
                    <div class="p-3 bg-light rounded-4 border">
                        <p class="text-muted small text-uppercase fw-bold mb-1">Nomor Induk Pegawai (NIP)</p>
                        <h5 class="text-dark fw-bold mb-0" style="font-family: monospace;">{{ $dosen->nip ?? 'Belum ada NIP' }}</h5>
                    </div>
                </div>
            </div>
        </div>
