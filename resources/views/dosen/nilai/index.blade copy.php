                ...
                <table class="table table-rekap align-middle mb-0">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th scope="col" class="px-4 py-3 th-header fw-bold text-center border-start">Nilai 5 Kuis</th>
...
<tbody>
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-3 text-center border-start">
                                <div class="d-flex flex-wrap justify-content-center gap-1" style="max-width: 140px; margin: 0 auto;">
                                    <span class="badge {{ $q_pendahuluan >= 70 ? 'bg-success text-success border-success' : 'bg-danger text-danger border-danger' }} bg-opacity-10 border border-opacity-25" title="Pendahuluan" style="font-size: 0.7rem; width: 40px;">
                                        P: {{ $q_pendahuluan }}
                                    </span>
                                    <span class="badge {{ $q_bubble >= 70 ? 'bg-success text-success border-success' : 'bg-danger text-danger border-danger' }} bg-opacity-10 border border-opacity-25" title="Bubble Sort" style="font-size: 0.7rem; width: 40px;">
                                        B: {{ $q_bubble }}
                                    </span>
                                    <span class="badge {{ $q_selection >= 70 ? 'bg-success text-success border-success' : 'bg-danger text-danger border-danger' }} bg-opacity-10 border border-opacity-25" title="Selection Sort" style="font-size: 0.7rem; width: 40px;">
                                        S: {{ $q_selection }}
                                    </span>
                                    <span class="badge {{ $q_insertion >= 70 ? 'bg-success text-success border-success' : 'bg-danger text-danger border-danger' }} bg-opacity-10 border border-opacity-25" title="Insertion Sort" style="font-size: 0.7rem; width: 40px;">
                                        I: {{ $q_insertion }}
                                    </span>
                                    <span class="badge {{ $q_merge >= 70 ? 'bg-success text-success border-success' : 'bg-danger text-danger border-danger' }} bg-opacity-10 border border-opacity-25" title="Merge Sort" style="font-size: 0.7rem; width: 40px;">
                                        M: {{ $q_merge }}
                                    </span>
                                </div>
                            </td>
